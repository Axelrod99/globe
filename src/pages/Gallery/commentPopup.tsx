  ...
  return (
    <div className="relative rounded-[4px] w-[95%] md:w-[90%] overflow-y-scroll h-[90%] md:h-[80vh] lg:h-[90vh] shadow-sm bg-white text-black flex flex-col md:flex-row">
      ...
      <div className="h-full flex flex-col w-full border-l relative">
        <div className="md:border-b border-b-[#acacac] w-full h-fit p-2 text-[13px] md:text-[15px] mb-16 md:mb-0">
          <p>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis eos
            harum, adipisci veritatis libero odio ipsum sed atque totam beatae
            nemo consequatur rerum eius, eaque voluptates. Molestiae accusantium
            ratione neque.
          </p>
        </div>
        ...
        <>
          {loadingComment ? (
            ...
            <div className="h-[62%] flex flex-col overflow-y-scroll mt-2">
        ...
        <div className="px-2 border-t border-t-[#acacac] absolute bottom-0 w-full flex gap-1 py-1">
          <input
          ...
          <div className="w-[47px] flex justify-center">
            <div
              onClick={handleSend}
              className="cursor-pointer h-[43px] w-[43px] bg-gray-100 border border-gray-300 shadow rounded-[50px] flex justify-center items-center"
            >
