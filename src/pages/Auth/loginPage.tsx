    ...
    >
          ...
          <div className="w-[90%] xs:w-[60%] ">
            ...
            <div className="flex justify-center mt-5 text-[14px]">
              <p>
                ...
                <span onClick={()=> setIsLoggin(false)}  className="underline cursor-pointer">Sign up</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center py-10 rounded-[12px] my-14 bg-white shadow w-[95%] xs:w-[85%]">
          ...
          <div className="w-[90%] xs:w-[60%] ">
            ...
            <div className="flex justify-center mt-5 text-[14px]">
              <p>
                Don't have an account?{" "}
                <span onClick={()=> setIsLoggin(true)} className="underline cursor-pointer">Sign up</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mb-5">
        ...
        <div className="text-[10px] text-center mt-10 flex justify-center font-light">
          <p>
            © 2005-2024 Globe Ltd. All rights reserved. All trademarks
