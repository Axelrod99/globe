...
export const scheduleArray = [
  {
    ...
    speaker1: "Pst Yemi Adefarasin",
    speaker2: "Pst Victoria Orenze",
    speaker3: "Pst Adeyanju Olomola",
    speaker4: "Pst Jide Asumah",
    gmt: "pm",
    date: "March 26th",
  },
  {
...
export const ministers = [
  ...
  },
  {
    name: "FELA DUROTOYE",
    title: "Speaking",
    bio: "Fela DUROTOYE is a Values Champion, a Global Speaker, an Executive Coach, a Leadership Trainer and a Nation Builder. FD as he is fondly called, is the Founder and CEO of The GEMSTONE Group, a leadership development institution comprising of The Fela Durotoye Company, The GEMSTONE Leadership Institute, The GEMSTONE Leadership Network and The GEMSTONE Nation Builders Foundation. Fela is highly regarded as one of Africa’s leading Executive Coaches. He is an official member of the Forbes Coaches Council (an invitation-only community for senior- level executives in the global coaching industry). His consulting career, which has spanned over 32 years has significantly improved the leadership, corporate performance and service delivery culture of his clients across diverse sectors of the Nigerian economy and beyond. His clients include Access Bank, GTBank, First Bank, Zenith Bank, UBA, Shell Petroleum Development Corporation, Oando, Addax Petroleum, Total, NLNG, Airtel, MTN, 9mobile, Multichoice, Lafarge, P&G, Unilever, ECOWAS, State Government of Lagos, Oyo, Kwara, Ondo, Ekiti, Anambra, Rivers, to mention a few. FD sits on the board of several leading institutions and he’s a strategic adviser to several high impact leaders across the world. For almost a decade, he has chaired the board of directors of HOMEBASE MORTGAGE BANK, one of Nigeria’s leading mortgage banks. Fela is currently on a mission to help 1 million people develop their leadership capacity driven by values that will help them achieve personal success, happiness and fulfillment as they attain professional excellence and a legacy of distinction. His passion is building people into leaders, building organizations into global institutions and building families into transgenerational dynasties. Fela strongly believes in connecting leaders with ideas and opportunities for exponential growth so that they can achieve excellent results and outstanding success in their personal and professional lives as they positively impact their communities, nation, continent and the world at large. Fela Durotoye has been a guest lecturer on LEADERSHIP at the prestigious Stanford SEED Program, a strategic initiative of the prestigious Stanford University designed to assist CEOs of businesses with operations across the African Continent to accomplish transformational growth. Fela defines himself as a Nation Builder at heart and views leadership development and nation building as core to his essence and life’s purpose. Perhaps his greatest contribution to Leadership Development & National Transformation is his Values Infusion Program through which he has been able to get over a million people to commit to living an exemplary lifestyle of Leadership & Excellence as defined by a set of 10 Values Statements framed in The GEMSTONE Personal Creed that is now being widely adopted by families, corporate organizations, schools & educational institutions, professional associations and state governments in Nigeria and across the globe. Fela is renowned for several history-making projects and initiatives on the national stage, including the Mushin Makeover Project which has been acclaimed as the largest non-governmental urban renewal initiative in Africa’s history. He is the recipient of several social, industry, and national awards for his leadership development and Nation Building activities. Fela Durotoye is an accomplished author who has several of his best-selling books published on Amazon. Fela is an alumnus of the renowned Obafemi Awolowo University and has attended the Kennedy School of Government Executive Leadership program of the prestigious Harvard University as well as attending the High Impact Leadership course at the Yale University. He is happily married to Tara Fela-Durotoye, Founder of the House of Tara International; and together, they have 3 sons who think their dad is a superhero.",
    img: img2,
  },
  {
    name: "TOYOSI ETIM-EFFIONG",
    title: "Speaking ",
    bio: "prominent figure in the media and entertainment industry. With over a decade of experience, Toyosi, a TEDx Abuja speaker, has fostered the growth of the Nigerian creative economy, launching initiatives like the Independent Producers' Workshop. She’s also an advisor to Rolling Stone Africa and has held roles as Global Director of Content at MIPAD and Publishing Editor at Folio by CNN. Recognized as one of the 'Top 100 Most Influential Women' by Leading Ladies Africa and honored as one of the 'Eko 100 Women' by the Lagos State Government, her ongoing commitment is to elevate African narratives on the global stage.",
    img: img13,
  },
];
